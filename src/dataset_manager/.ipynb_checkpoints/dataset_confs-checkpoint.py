...
dynamic_cat_cols[dataset] = ["Resource.1", "Resource", "Report_Type","Activity"] 
dynamic_num_cols[dataset] = ["open_cases","Qty_Completed", "weekday","open_cases", "activity_duration", "Qty_for_MRB", "hour", "month", "event_nr"]
...
for formula in range(1,5):
    ...
    # features for classifier
    dynamic_activity_col[dataset] = ["Activity code"]
